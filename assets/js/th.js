const hitungDataTahunHijri = (tahun) => {
...
const hitungtahunhijri = () => {
  let tahun = document.querySelector("#tahunhijri").value;
  if (!tahun) {
    document.querySelector("#datatahunhijri").innerHTML = "Mohon maaf, harap masukan tahun!";
    return;
  }

  let { hasil, grade, tahuntam, bB, cC, gradeskabisah, gradesbasitoh, hH, hmth, iI, jJ, hmp, kbbs } = hitungDataTahunHijri(parseInt(tahun));
  ...
  document.querySelector("#datatahunhijri").innerHTML = `
...
const hasiltahunhijri = () => {
  let tahun = document.querySelector("#tahunhijri").value;
  if (!tahun) {
    document.querySelector("#datatahunhijri").innerHTML = "Mohon maaf, harap masukan tahun!";
    return;
  }
  let { hasil, grade, tahuntam, bB, cC, gradeskabisah, gradesbasitoh, hmth, hmp, kbbs } = hitungDataTahunHijri(parseInt(tahun));
  document.querySelector("#datatahunhijri").innerHTML = `
    <table class="table-harokat">
